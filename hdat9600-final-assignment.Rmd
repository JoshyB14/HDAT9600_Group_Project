...
summary(icu_patients_df1$Height)
...
# ----------------------- Height by gender -------------------------------------#
# Plot
# We see that there are some very tall women (400+) and some obs near 0, so the second plot
  # restricts the axes to where the bulk of the observations are
ggplot(data = icu_patients_df1, aes(x = Height, fill = Gender)) + geom_histogram() +
   facet_grid(Gender ~ .)
